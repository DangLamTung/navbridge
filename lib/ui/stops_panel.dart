    ...
    return Material(
      ...
      child: Column(
        ...
        children: [
          ...
          // Stop rows scroll (capped at 240px) instead of inflating the
          // panel to cover the whole screen when many stops are added. The
          // header stays pinned. "Thêm điểm dừng" lives in the top
